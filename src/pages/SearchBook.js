...
const ServiceBookSearch = ({ user, onCancel }) => {
  ...
  const [employees, setEmployees] = useState([
    ...
    { id: 2, name: 'Jane Smith', code: 'EMP002', department: 'HR', designation: 'HR Manager', status: 'Active', joiningDate: '2019-06-10', retirementDate: null, photo: null },
    { id: 3, name: 'Mike Johnson', code: 'EMP003', department: 'IT', designation: 'Senior Developer', status: 'Active', joiningDate: '2021-03-20', retirementDate: null, photo: null },
    { id: 4, name: 'Sarah Williams', code: 'EMP004', department: 'Sales', designation: 'Sales Manager', status: 'Retired', joiningDate: '2010-08-01', retirementDate: '2024-03-31', photo: null },
    { id: 5, name: 'David Brown', code: 'EMP005', department: 'Finance', designation: 'Accountant', status: 'Terminated', joiningDate: '2022-01-10', retirementDate: null, photo: null }
  ]);
