...
//               <span>{filteredAppointments.filter(a => a.confirmationDueDate && new Date(a.confirmationDueDate) > new Date()).length} On Probation</span>
//             </div>
//             <div className="cert-stat-card">
//               <FaTimes size={16} color="#ef4444" />
//               <span>{filteredAppointments.filter(a => a.confirmationDueDate && new Date(a.confirmationDueDate) <= new Date()).length} Confirmed</span>
//             </div>
//           </div>
...
//                             <span className="cert-status-badge" style={{ background: '#fed7aa', color: '#9a3412' }}>On Probation</span>
//                           ) : apt.confirmationDueDate ? (
//                             <span className="cert-status-badge" style={{ background: '#d1fae5', color: '#065f46' }}>Confirmed</span>
//                           ) : (
...
//                     ))
//                   ) : (
//                     <tr><td colSpan="9" className="text-center py-5">No appointments found</td></tr>
//                   )}
//                 </tbody>
//               </table>
//             </div>
